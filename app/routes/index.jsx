import { useLoaderData, Link, Form, json} from "remix";
...
export async function action({ request }) {
  ...
  switch (actionType){
    ...
    try {
      await db.models.Note.findByIdAndUpdate(
        noteId, {fav: isFav === "true" ? false : true});
    ...
    <div className="main">
        ...
        <div className="snippets">
          <div className="sniphead">
            ...
            <div className="Sort">
              <Form>
              <Button type="submit" name="_title" value="sortTitle">Title</Button>
              <Button type="submit" name="_update" value="lastUpdate">Last Update</Button>
              <Button type="submit" name="_favorite" value="sortFav">Favorite</Button>
              </Form>
            </div>
              <ul>
                  {notes.map((note, i) => {
                      ...
                      <div className={showSnip == i ? 'block' : 'hidden'}  key={note._id} id={note._id}>
                        <h2>{note.title}</h2>
                            ...
                            <Form method="post">
                               ...
                               <input type="hidden" name="fav" value={note.fav?.toString()}/>
